...
import daggerok.CheckerAPI.{BlacklistUserResponse, CheckUserRequest, WhitelistUserResponse}
import daggerok.RecorderAPI.CreateUser
import daggerok.StorageAPI.AddUser
...
object Application {
  def main(args: Array[String]): Unit = {
    val system = ActorSystem("user-management-system")
